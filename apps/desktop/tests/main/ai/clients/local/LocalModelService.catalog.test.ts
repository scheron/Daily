...
import {LocalModelService} from "../../../../../src/main/ai/clients/local/core/LocalModelService"
...
describe("LocalModelService catalog", () => {
  ...
  it("refreshCatalog replaces the in-memory catalog and writes the cache on success", async () => {
    ...
    const {readCachedCatalog} = await import("../../../../../src/main/ai/clients/local/core/remoteCatalog")
