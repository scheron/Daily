...
import {useActivityModel} from "../../../../src/renderer/src/ui/modules/LeftPanel/{fragments}/ActivityWidget/model/useActivityModel"
...
vi.mock("../../../../src/renderer/src/stores/storage.store", () => ({
  useStorageStore: () => mocks.storageStore,
}))

vi.mock("../../../../src/renderer/src/stores/task-editor", () => ({
  useTaskEditorStore: () => mocks.taskEditorStore,
}))

vi.mock("../../../../src/renderer/src/stores/tasks", () => ({
