...
import ModelPicker from "./{fragments}/ModelPicker.vue"
...
<template>
  <div class="flex flex-col gap-1">
    ...
    <SettingRow v-if="aiStore.availableModels.length" title="Model" description="The language model that serves as the assistant's brain">
      <ModelPicker :model-value="aiConfig.model" :options="aiStore.availableModels" @update:model-value="onSelectModel" />
    </SettingRow>
