...
import ServerConnectSteps from "./{fragments}/ServerConnectSteps.vue"
  ...
  <BaseModal :title="title" container-class="mx-4 h-auto w-full max-w-md rounded-xl" content-class="!p-5" @close="emit('close')">
    ...
    <div v-else-if="step === 'confirm-off'" class="flex flex-col gap-4">
      ...
      <div class="flex items-center justify-end gap-2">
        ...
        <BaseButton variant="primary" :loading="isLoading" @click="onConfirmOff">Stop Syncing</BaseButton>
      </div>
    </div>
    ...
    <div v-else-if="step === 'preview' && preview" class="flex flex-col gap-4">
      ...
      <div class="flex items-center justify-end gap-2">
        <BaseButton variant="text" @click="emit('close')">Cancel</BaseButton>
        <BaseButton variant="primary" :disabled="!canSwitch" :loading="isLoading" @click="onSwitch">Switch</BaseButton>
      </div>
    </div>
  </BaseModal>
</template>
