...
function getStatusIconClasses(isBusy: boolean) {
  return cn("size-4", isBusy && "animate-spin")
}
</script>
          ...
          <div class="flex w-full items-center justify-between gap-2">
            <div class="flex items-center gap-1">
              <span class="text-base-content flex size-6 shrink-0 items-center justify-center rounded-full">
                <BaseIcon :name="updateStore.isBusy ? 'spinner' : 'info'" :class="getStatusIconClasses(updateStore.isBusy)" />
              </span>
