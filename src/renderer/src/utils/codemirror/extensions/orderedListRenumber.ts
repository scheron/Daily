...
function collectOrderedLists(state: EditorState, ranges: ReadonlyArray<Range>): SyntaxNode[] {
  ...
  function record(node: SyntaxNode): void {
...
function appendRenumberChanges(state: EditorState, list: SyntaxNode, multiLineRanges: ReadonlyArray<Range>, out: ChangeSpec[]): void {
