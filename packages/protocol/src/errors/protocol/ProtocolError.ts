...
const STATUS: Record<ProtocolErrorCode, number> = {
  ...
  [ProtocolErrorCode.NOT_PARENT]: 403,
  [ProtocolErrorCode.ENROLLMENT_WINDOW_CLOSED]: 409,
  [ProtocolErrorCode.DEVICE_NOT_FOUND]: 404,
  [ProtocolErrorCode.CANNOT_REVOKE_PARENT]: 409,
