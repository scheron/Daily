...
import {RemoteSnapshotPendingError, SnapshotVersionAheadError, SyncErrorCode} from "@daily/protocol"
...
import type {IRemoteStorage, Snapshot, SnapshotFile} from "@daily/protocol"
