...
This release focuses on the AI assistant — it now streams, remembers, and connects to outside tools.
...
- Tool calls that change your data ask for explicit confirmation before running.
...
- Expose Daily's task and project actions over a local MCP endpoint so external tools can read and edit your data with your permission.
- The protocol surface is still settling; please report anything unexpected.
